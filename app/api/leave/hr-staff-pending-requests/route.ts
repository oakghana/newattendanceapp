...
export async function GET(request: NextRequest) {
  try {
    ...
    const isHrExecutive = ["admin", "director_hr", "manager_hr", "hr_executive", "hr_director", "hr_leave_office", "hr_office", "hr", "regional_hr", "regional_hr_officer", "regional_hr_office", "regional_hr_leave_office", "regional_leave_office"].includes(role)
