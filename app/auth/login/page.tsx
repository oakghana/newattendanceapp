      ...
      <div className="w-full max-w-md scale-in">
        <Card className="backdrop-blur-xl bg-background/95 shadow-2xl border border-border/40 hover:border-border/60 transition-all duration-300 rounded-2xl">
          ...
          <div className="mt-6 text-center border-t border-border pt-6">
            ...
            <p className="inline-flex items-center mt-3 rounded-full border border-primary/30 bg-primary px-4 py-1.5 text-xs font-semibold tracking-wide text-primary-foreground shadow-[0_4px_0_hsl(var(--primary)/0.45),0_6px_12px_hsl(var(--primary)/0.18)] transition-transform hover:-translate-y-0.5">🚀 V.2.1-19-09-26</p>
          </div>
          </CardContent>
        </Card>
      </div>
