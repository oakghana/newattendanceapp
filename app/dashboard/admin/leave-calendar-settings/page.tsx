...
export default function LeaveCalendarSettingsPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-3xl font-bold">Leave Calendar Settings</h1>
        <p className="text-gray-600">Configure leave year periods and manage public holidays</p>
      </div>
