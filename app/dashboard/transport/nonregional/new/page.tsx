...
export default async function NewNonRegionalRequisitionPage() {
  ...
  if (!isAssignedHod && !["staff", "department_head", "hr", "hr_executive", "hr_executive_officer", "manager_hr", "director_hr", "admin", "it-admin"].includes(normalizeAppRole(profile?.role))) redirect("/dashboard/transport/nonregional")
