                ...
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-blue-500 mt-1">All {loanOfficeAnalytics.totals.total_requests} loan requests</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-emerald-500 mt-1">Approved loans in pipeline</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-amber-500 mt-1">Per loan request</p>
                    </div>
                  </div>
                </div>
              </div>
