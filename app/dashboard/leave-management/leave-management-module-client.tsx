...
import { BarChart3, CalendarRange, LayoutPanelTop, TrendingUp, Gift, Info } from "lucide-react"
...
export function LeaveManagementModuleClient({
  ...
  return (
    <div className="space-y-6 w-full">
      <Tabs defaultValue={isRegionalHR ? "info" : "leave-management"} className="space-y-4 w-full">
        <TabsList className="flex h-auto w-full flex-wrap gap-2 rounded-3xl border border-blue-100 bg-blue-50/60 p-2 shadow-sm overflow-x-auto sm:overflow-visible">
          ...
          {/* Regional HR Officers — view-only, no action tabs */}
          {!isRegionalHR && (
            <>
        ...
        {/* Leave Management Tab — hidden for regional HR */}
        {!isRegionalHR && (
        ...
        {/* Leave Planning Tab — hidden for regional HR */}
        {!isRegionalHR && (
