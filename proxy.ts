...
const PROTECTED_ROUTES: Record<string, string[]> = {
  ...
  "/dashboard/transport": ["admin", "administrator", "it-admin", "it_admin", "driver", "chief_driver", "regional_chief_driver", "staff", "transport_manager", "regional_hr", "regional_hr_office", "regional_hr_officer", "regional_hr_leave_office", "regional_leave_office", "regional_manager", "hr_records", "hr_records_officer", "hr_records_manager", "department_head", "accounts_executive", "managing_director", "director_hr", "manager_hr", "hr", "hr_executive", "hr_executive_officer"],
