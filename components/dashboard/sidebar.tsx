...
const navigationItems = [
  {
    ...
    icon: Home,
    roles: ["admin", "it-admin", "regional_manager", "department_head", "staff", "loan_office", "accounts", "director_hr", "manager_hr", "hr_office", "hr_leave_office_admin", "audit_staff", "nsp", "intern", "contract"],
    category: "main",
  },
  {
  ...
  },
  {
    ...
    icon: Calendar,
    roles: ["admin", "regional_manager", "department_head", "staff", "it-admin", "nsp", "intern", "loan_office", "accounts", "director_hr", "manager_hr", "hr_office", "hr_leave_office_admin", "audit_staff", "contract"],
    category: "admin",
  },
  {
  ...
  },
  {
    ...
    icon: Settings,
    roles: ["admin", "it-admin", "regional_manager", "department_head", "staff", "hr_leave_office_admin"],
    category: "settings",
  },
]
