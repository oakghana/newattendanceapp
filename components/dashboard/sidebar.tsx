...
const navigationItems = [
  ...
  },
  {
    ...
    icon: Banknote,
    roles: ["admin", "it-admin", "regional_manager", "department_head", "staff", "nsp", "intern", "loan_office", "accounts", "director_hr", "manager_hr", "hr_office", "hr_leave_office", "audit_staff", "contract"],
    category: "main",
  },
  {
    title: "Help Center",
