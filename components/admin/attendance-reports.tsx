...
export function AttendanceReports({
  ...
  return (
    <div className={`${compactMode ? "space-y-2 text-sm" : "space-y-4"} text-slate-900 dark:text-slate-100`}>
      {/* Advanced Filters */}
        <div className="bg-white/95 dark:bg-slate-900/90 rounded-2xl shadow-lg border border-gray-200/80 dark:border-slate-700/80 overflow-hidden backdrop-blur-xl">
          ...
          <div className={compactMode ? "p-2" : "p-4 sm:p-5 md:p-6"}>
            {exportError && (
              <div className="bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-900 rounded-xl p-3 mb-2 flex items-start gap-3">
                <AlertTriangle className="h-4 w-4 text-red-500 mt-0.5 flex-shrink-0" />
                <p className="text-red-700 dark:text-red-300 text-sm font-medium">{exportError}</p>
              </div>
            )}
          </div>
        ...
        <div className={compactMode ? "p-2" : "p-4 sm:p-5 md:p-6"}>
          ...
          <div className={compactMode ? "grid gap-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 mb-3 items-end" : "grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-4 items-end"}>
            <div className="space-y-3">
              ...
              <input
                ...
                className={`w-full border border-gray-200 dark:border-slate-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-150 bg-gray-50 dark:bg-slate-800 hover:bg-white dark:hover:bg-slate-700 text-gray-900 dark:text-slate-100 ${compactMode ? 'px-2 py-1 text-xs' : 'px-3 py-2 text-sm'}`}
              />
            </div>
          ...
          {!loading && records.length === 0 && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100 mb-2">No Data Found</h3>
              <p className="text-gray-500 dark:text-slate-400">Try adjusting your filters or date range to see attendance records.</p>
            </div>
          )}
        </div>
      </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} defaultValue="details" className="w-full">
            ...
            <TabsContent value="overview" className="px-4 py-4 space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 rounded-xl p-3 sm:p-4 md:p-6 border border-blue-100 dark:border-slate-700">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="p-3 bg-blue-100 rounded-xl">
                      <BarChart3 className="h-6 w-6 text-blue-600" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100">Attendance by Department</h3>
                      <p className="text-gray-600 dark:text-slate-400">Distribution of attendance records</p>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-slate-900 dark:to-slate-800 rounded-xl p-3 sm:p-4 md:p-6 border border-green-100 dark:border-slate-700">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="p-3 bg-green-100 rounded-xl">
                      <CheckCircle className="h-6 w-6 text-green-600" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100">Attendance Status</h3>
                      <p className="text-gray-600 dark:text-slate-400">Breakdown of attendance statuses</p>
                    </div>
                  </div>
                  <div className="h-48 md:h-80">
                    <ResponsiveContainer width="100%" height="100%">
